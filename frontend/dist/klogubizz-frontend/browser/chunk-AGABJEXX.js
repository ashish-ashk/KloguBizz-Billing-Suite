...
var AuthService = class _AuthService {
  http;
  router;
  tokenKey = "klogubizz_token";
  userKey = "klogubizz_user";
  orgKey = "klogubizz_org";
  user = signal(this.readJson(this.userKey));
  organisation = signal(this.readJson(this.orgKey));
  ...
  login(email, password) {
    return this.http.post(`${environment.apiUrl}/auth/login`, { email, password }).pipe(tap((res) => this.store(res)));
  }
  register(payload) {
    return this.http.post(`${environment.apiUrl}/auth/register`, payload).pipe(tap((res) => this.store(res)));
  }
  ...
  store(res) {
    ...
    if (res.organisation)
      localStorage.setItem(this.orgKey, JSON.stringify(res.organisation));
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-AGABJEXX.js.map
