...
var routes = [
  ...
  { path: "sla", data: { type: "sla" }, loadComponent: () => import("./chunk-7RT4D47J.js").then((m) => m.LegalPageComponent) },
  {
    ...
    children: [
      { path: "dashboard", loadComponent: () => import("./chunk-LZA5KMWW.js").then((m) => m.DashboardComponent) },
      { path: "invoices", loadComponent: () => import("./chunk-GV4LNZ5S.js").then((m) => m.InvoicesComponent) },
      { path: "invoices/new", loadComponent: () => import("./chunk-IGN3AV7Q.js").then((m) => m.InvoiceEditorComponent) },
      { path: "invoices/:id/edit", loadComponent: () => import("./chunk-IGN3AV7Q.js").then((m) => m.InvoiceEditorComponent) },
      { path: "invoices/:id/print", loadComponent: () => import("./chunk-AXPBGG7P.js").then((m) => m.InvoicePrintComponent) },
      { path: "bill-generator", loadComponent: () => import("./chunk-RZP7CLA2.js").then((m) => m.BillGeneratorComponent) },
      { path: "bill-generator/:id/edit", loadComponent: () => import("./chunk-RZP7CLA2.js").then((m) => m.BillGeneratorComponent) },
      { path: "clients", loadComponent: () => import("./chunk-DPBEWVN6.js").then((m) => m.ClientsComponent) },
      { path: "items", loadComponent: () => import("./chunk-AVHUBFRL.js").then((m) => m.ItemsComponent) },
      { path: "payments", loadComponent: () => import("./chunk-E2ETEKVQ.js").then((m) => m.PaymentsComponent) },
      { path: "reports", loadComponent: () => import("./chunk-M4WOQD6W.js").then((m) => m.ReportsComponent) },
      { path: "users", loadComponent: () => import("./chunk-MDPRHC3A.js").then((m) => m.UsersComponent) },
      { path: "subscription", loadComponent: () => import("./chunk-RGHA2LJH.js").then((m) => m.SubscriptionComponent) },
      { path: "appearance", canActivate: [tenantAdminGuard], loadComponent: () => import("./chunk-TCBDUDJY.js").then((m) => m.AppearanceComponent) },
      { path: "invoice-templates", canActivate: [tenantAdminGuard], loadComponent: () => import("./chunk-ZM56Y7ZF.js").then((m) => m.InvoiceTemplatesComponent) },
