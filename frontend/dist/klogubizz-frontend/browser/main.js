...
var routes = [
  { path: "login", loadComponent: () => import("./chunk-FU5XYJBB.js").then((m) => m.LoginComponent) },
  { path: "register", loadComponent: () => import("./chunk-IBB5CKEK.js").then((m) => m.RegisterComponent) },
  ...
  { path: "sla", data: { type: "sla" }, loadComponent: () => import("./chunk-7RT4D47J.js").then((m) => m.LegalPageComponent) },
  {
    ...
    children: [
      { path: "dashboard", loadComponent: () => import("./chunk-7DTJP3PZ.js").then((m) => m.DashboardComponent) },
      { path: "invoices", loadComponent: () => import("./chunk-TEEZZEEL.js").then((m) => m.InvoicesComponent) },
      { path: "invoices/new", loadComponent: () => import("./chunk-UWTSDQ5W.js").then((m) => m.InvoiceEditorComponent) },
      { path: "invoices/:id/edit", loadComponent: () => import("./chunk-UWTSDQ5W.js").then((m) => m.InvoiceEditorComponent) },
      { path: "invoices/:id/print", loadComponent: () => import("./chunk-AXPBGG7P.js").then((m) => m.InvoicePrintComponent) },
      { path: "bill-generator", loadComponent: () => import("./chunk-YH5HJX7L.js").then((m) => m.BillGeneratorComponent) },
      { path: "bill-generator/:id/edit", loadComponent: () => import("./chunk-YH5HJX7L.js").then((m) => m.BillGeneratorComponent) },
      { path: "clients", loadComponent: () => import("./chunk-7IWHJEBI.js").then((m) => m.ClientsComponent) },
      { path: "items", loadComponent: () => import("./chunk-VBQQAJKW.js").then((m) => m.ItemsComponent) },
      { path: "payments", loadComponent: () => import("./chunk-ODQ5OH5X.js").then((m) => m.PaymentsComponent) },
      { path: "reports", loadComponent: () => import("./chunk-TIQK6YKC.js").then((m) => m.ReportsComponent) },
      { path: "users", loadComponent: () => import("./chunk-6O27UW43.js").then((m) => m.UsersComponent) },
      { path: "subscription", loadComponent: () => import("./chunk-HJYTRHNM.js").then((m) => m.SubscriptionComponent) },
      { path: "appearance", canActivate: [tenantAdminGuard], loadComponent: () => import("./chunk-7QAE5ER4.js").then((m) => m.AppearanceComponent) },
      { path: "invoice-templates", canActivate: [tenantAdminGuard], loadComponent: () => import("./chunk-AUZCPZO4.js").then((m) => m.InvoiceTemplatesComponent) },
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-QPVU7FHZ.js").then((m) => m.SuperAdminLayoutComponent),
    children: [
