...
function SuperAdminLayoutComponent_Conditional_91_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("name", ((tmp_1_0 = ctx_r1.auth.user()) == null ? null : tmp_1_0.name) || "?")("size", 36);
    \u0275\u0275advance(3);
...
var SuperAdminLayoutComponent = class _SuperAdminLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SuperAdminLayoutComponent, selectors: [["app-super-admin-layout"]], viewQuery: function SuperAdminLayoutComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function SuperAdminLayoutComponent_Template_button_click_5_listener() {
      ...
      \u0275\u0275element(15, "app-icon", 10);
      \u0275\u0275elementStart(16, "span", 14);
      \u0275\u0275text(17, "Owner Panel");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(18, "nav", 15);
      \u0275\u0275listener("click", function SuperAdminLayoutComponent_Template_nav_click_18_listener() {
        return ctx.menuOpen.set(false);
      });
      \u0275\u0275elementStart(19, "div", 16);
      \u0275\u0275text(20, "Core Management");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "a", 17)(22, "span", 18);
      \u0275\u0275element(23, "app-icon", 19);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "span", 14);
      \u0275\u0275text(25, "Organizations");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(26, "a", 20)(27, "span", 18);
      ...
      \u0275\u0275text(32, "Global Settings");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "a", 22)(34, "span", 18);
      \u0275\u0275element(35, "app-icon", 23);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(36, "span", 14);
      \u0275\u0275text(37, "Invoice Templates");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(38, "a", 24)(39, "span", 18);
      \u0275\u0275element(40, "app-icon", 25);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(41, "span", 14);
      \u0275\u0275text(42, "Reminders & Receipts");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(43, "a", 26)(44, "span", 18);
      \u0275\u0275element(45, "app-icon", 27);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(46, "span", 14);
      \u0275\u0275text(47, "Subscription Plans");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(48, "a", 28)(49, "span", 18);
      \u0275\u0275element(50, "app-icon", 29);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(51, "span", 14);
      \u0275\u0275text(52, "Branding & Logo");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(53, "a", 30)(54, "span", 18);
      \u0275\u0275element(55, "app-icon", 31);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(56, "span", 14);
      \u0275\u0275text(57, "Profile & Security");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(58, "div", 32);
      \u0275\u0275elementStart(59, "a", 33)(60, "span", 18);
      \u0275\u0275element(61, "app-icon", 34);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(62, "span", 14);
      \u0275\u0275text(63, "Tenant App");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(64, "div", 35)(65, "div", 36)(66, "div", 37);
      \u0275\u0275element(67, "app-avatar", 6);
      ...
      \u0275\u0275listener("click", function SuperAdminLayoutComponent_Template_button_click_73_listener() {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("size", 10);
      \u0275\u0275advance(52);
      \u0275\u0275property("name", ((tmp_10_0 = ctx.auth.user()) == null ? null : tmp_10_0.name) || "?")("size", 32);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(((tmp_12_0 = ctx.auth.user()) == null ? null : tmp_12_0.name) || "\u2014");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate((tmp_13_0 = ctx.auth.user()) == null ? null : tmp_13_0.email);
      \u0275\u0275advance(2);
      \u0275\u0275property("size", 15);
      \u0275\u0275advance(6);
      \u0275\u0275property("size", 13);
      ...
      \u0275\u0275advance(3);
      \u0275\u0275property("name", ((tmp_17_0 = ctx.auth.user()) == null ? null : tmp_17_0.name) || "?")("size", 34);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate((tmp_19_0 = ctx.auth.user()) == null ? null : tmp_19_0.name);
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperAdminLayoutComponent, { className: "SuperAdminLayoutComponent", filePath: "src\\app\\features\\super-admin\\super-admin-layout.component.ts", lineNumber: 112 });
})();
export {
  SuperAdminLayoutComponent
};
//# sourceMappingURL=chunk-RQKUFZRQ.js.map
