...
function InvoiceEditorComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, "\u{1F5A8} Preview / Print");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function InvoiceEditorComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "app-skeleton-rows", 8);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function InvoiceEditorComponent_Conditional_10_Conditional_30_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, "\u26A1 Inter-state supply \u2014 IGST applicable");
    \u0275\u0275elementEnd();
  }
}
function InvoiceEditorComponent_Conditional_10_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(11, InvoiceEditorComponent_Conditional_10_Conditional_30_Conditional_11_Template, 2, 0, "div", 53);
  }
  if (rf & 2) {
    const c_r4 = ctx;
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function InvoiceEditorComponent_Conditional_10_For_56_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function InvoiceEditorComponent_Conditional_10_For_56_Conditional_16_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const \u0275$index_145_r9 = \u0275\u0275nextContext().$index;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.removeItem(\u0275$index_145_r9));
    });
    \u0275\u0275text(1, "\u2715");
    \u0275\u0275elementEnd();
  }
...
function InvoiceEditorComponent_Conditional_10_For_56_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275twoWayListener("ngModelChange", function InvoiceEditorComponent_Conditional_10_For_56_Template_input_ngModelChange_2_listener($event) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "td")(8, "input", 57);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "td")(10, "select", 58);
    ...
    \u0275\u0275repeaterCreate(11, InvoiceEditorComponent_Conditional_10_For_56_For_12_Template, 2, 2, "option", 59, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "td", 60);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "td", 26);
    \u0275\u0275template(16, InvoiceEditorComponent_Conditional_10_For_56_Conditional_16_Template, 2, 0, "button", 61);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275twoWayProperty("ngModel", item_r6.desc);
    \u0275\u0275advance(2);
...
function InvoiceEditorComponent_Conditional_10_Conditional_94_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 37)(1, "span", 63);
    \u0275\u0275text(2, "IGST");
    \u0275\u0275elementEnd();
...
function InvoiceEditorComponent_Conditional_10_Conditional_95_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 37)(6, "span", 63);
    \u0275\u0275text(7, "SGST");
    \u0275\u0275elementEnd();
...
function InvoiceEditorComponent_Conditional_10_Conditional_121_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, InvoiceEditorComponent_Conditional_10_Conditional_121_Conditional_0_Template, 5, 2, "div", 64)(1, InvoiceEditorComponent_Conditional_10_Conditional_121_Conditional_1_Template, 5, 1, "div", 65);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function InvoiceEditorComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 7)(1, "div", 9)(2, "section", 10)(3, "div", 11);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(18, "section", 10)(19, "div", 11);
    \u0275\u0275text(20, "Bill To");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(27, InvoiceEditorComponent_Conditional_10_For_28_Template, 2, 2, "option", 18, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275template(29, InvoiceEditorComponent_Conditional_10_Conditional_29_Template, 2, 1, "span", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275template(30, InvoiceEditorComponent_Conditional_10_Conditional_30_Template, 12, 8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "section", 10)(32, "div", 20)(33, "div", 21);
    ...
    \u0275\u0275text(36, "+ Add item");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "div", 23)(38, "table", 24)(39, "thead")(40, "tr")(41, "th", 25);
    ...
    \u0275\u0275repeaterCreate(55, InvoiceEditorComponent_Conditional_10_For_56_Template, 17, 7, "tr", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(57, InvoiceEditorComponent_Conditional_10_Conditional_57_Template, 3, 1, "div", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "section", 10)(59, "div", 11);
    \u0275\u0275text(60, "Additional Details");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "div", 28)(62, "div", 13)(63, "label");
    \u0275\u0275text(64, "Payment Terms");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "select", 16);
    ...
    \u0275\u0275repeaterCreate(66, InvoiceEditorComponent_Conditional_10_For_67_Template, 2, 2, "option", 18, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(68, "div", 13)(69, "label");
    \u0275\u0275text(70, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "select", 16);
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(84, "div", 35)(85, "section", 10)(86, "div", 11);
    \u0275\u0275text(87, "Invoice Summary");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(88, "div", 36)(89, "div", 37)(90, "span", 38);
    \u0275\u0275text(91, "Subtotal");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(92, "span", 39);
    \u0275\u0275text(93);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(94, InvoiceEditorComponent_Conditional_10_Conditional_94_Template, 5, 1, "div", 37)(95, InvoiceEditorComponent_Conditional_10_Conditional_95_Template, 10, 2);
    \u0275\u0275elementStart(96, "div", 40)(97, "span", 41);
    \u0275\u0275text(98, "Total");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(99, "span", 42);
    \u0275\u0275text(100);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(101, "div", 43)(102, "strong");
    \u0275\u0275text(103, "In words:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(104);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(105, "section", 10)(106, "div", 11);
    \u0275\u0275text(107, "Bank Details");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(108, "div", 44)(109, "div", 13)(110, "label");
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(113, "div", 13)(114, "label");
    \u0275\u0275text(115, "Account Number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(116, "input", 46);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(117, "div", 13)(118, "label");
    \u0275\u0275text(119, "IFSC Code");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(120, "input", 47);
...
var InvoiceEditorComponent = class _InvoiceEditorComponent {
  ...
  }, dependencies: [CommonModule, FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, NumberValueAccessor, SelectControlValueAccessor, NgControlStatus, MinValidator, NgModel, RouterLink, AppShellComponent, AvatarComponent, SkeletonRowsComponent], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InvoiceEditorComponent, { className: "InvoiceEditorComponent", filePath: "src\\app\\features\\invoices\\invoice-editor.component.ts", lineNumber: 193 });
})();
export {
  InvoiceEditorComponent
};
//# sourceMappingURL=chunk-LFD7K4WW.js.map
