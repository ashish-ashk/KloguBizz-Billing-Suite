...
function SubscriptionComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "app-skeleton-rows", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 11);
    \u0275\u0275element(3, "app-skeleton-rows", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function SubscriptionComponent_Conditional_2_Conditional_0_For_54_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, SubscriptionComponent_Conditional_2_Conditional_0_For_54_Conditional_1_Template, 2, 0, "span", 43)(2, SubscriptionComponent_Conditional_2_Conditional_0_For_54_Conditional_2_Template, 2, 0, "span", 44);
    \u0275\u0275elementStart(3, "div", 45);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 46);
    \u0275\u0275template(6, SubscriptionComponent_Conditional_2_Conditional_0_For_54_Conditional_6_Template, 2, 2, "span", 47)(7, SubscriptionComponent_Conditional_2_Conditional_0_For_54_Conditional_7_Template, 4, 4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 48);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 49);
    \u0275\u0275repeaterCreate(11, SubscriptionComponent_Conditional_2_Conditional_0_For_54_For_12_Template, 4, 4, "div", 50, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, SubscriptionComponent_Conditional_2_Conditional_0_For_54_Conditional_13_Template, 2, 0, "button", 51)(14, SubscriptionComponent_Conditional_2_Conditional_0_For_54_Conditional_14_Template, 2, 0, "button", 52)(15, SubscriptionComponent_Conditional_2_Conditional_0_For_54_Conditional_15_Template, 2, 1, "button", 53);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SubscriptionComponent_Conditional_2_Conditional_0_Conditional_62_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 41)(1, "table", 60)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5, "Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    ...
    \u0275\u0275element(12, "th");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "tbody")(14, "tr")(15, "td", 61);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(22, "app-pill", 65);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "td", 66)(24, "div", 67)(25, "button", 68);
...
function SubscriptionComponent_Conditional_2_Conditional_0_Conditional_63_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-empty-state", 42);
  }
}
function SubscriptionComponent_Conditional_2_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 16)(6, "h2", 17);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(18, "div", 23)(19, "div")(20, "div", 24);
    \u0275\u0275text(21, "Users");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(25, "div", 27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div")(27, "div", 24);
    ...
    \u0275\u0275element(32, "div", 28);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div")(34, "div", 24);
    ...
    \u0275\u0275text(42);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(43, "div", 30)(44, "h2", 31);
    ...
    \u0275\u0275text(50, "Yearly");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(51, SubscriptionComponent_Conditional_2_Conditional_0_Conditional_51_Template, 2, 0, "span", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "section", 35);
    \u0275\u0275repeaterCreate(53, SubscriptionComponent_Conditional_2_Conditional_0_For_54_Template, 16, 6, "div", 36, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "div", 37)(56, "div", 38)(57, "div")(58, "div", 39);
    \u0275\u0275text(59, "Billing History");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "div", 40);
    \u0275\u0275text(61, "Recent subscription charges");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(62, SubscriptionComponent_Conditional_2_Conditional_0_Conditional_62_Template, 28, 7, "div", 41)(63, SubscriptionComponent_Conditional_2_Conditional_0_Conditional_63_Template, 1, 0, "app-empty-state", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_3_0;
    ...
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("background", ctx_r1.invoiceHot() ? "var(--red-border)" : "#fff")("width", ctx_r1.invoicePct(), "%");
    \u0275\u0275advance(5);
...
function SubscriptionComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SubscriptionComponent_Conditional_2_Conditional_0_Template, 64, 22)(1, SubscriptionComponent_Conditional_2_Conditional_1_Template, 1, 0, "app-empty-state", 12);
  }
  if (rf & 2) {
    let tmp_1_0;
...
function SubscriptionComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, SubscriptionComponent_Conditional_4_Conditional_5_Template, 2, 1, "div", 72);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 73);
    \u0275\u0275repeaterCreate(7, SubscriptionComponent_Conditional_4_For_8_Template, 4, 2, "div", 50, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(13, SubscriptionComponent_Conditional_4_Conditional_13_Template, 1, 0, "span", 8);
...
var SubscriptionComponent = class _SubscriptionComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SubscriptionComponent, selectors: [["app-subscription"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 16, vars: 10, consts: [["title", "Subscription", "subtitle", "Manage your plan and billing"], [3, "close", "open", "width", "title"], ["title", "Cancel Subscription", 3, "close", "open", "width"], [1, "info-box", "danger", 2, "display", "flex", "gap", "8px", "align-items", "flex-start"], ["name", "alertTriangle", 2, "flex-shrink", "0", "margin-top", "1px", 3, "size"], [1, "modal-foot"], ["type", "button", 1, "btn", "ghost", 3, "click"], ["type", "button", 1, "btn", "danger", "solid", 3, "click", "disabled"], [1, "spinner"], [1, "card", 2, "margin-bottom", "16px"], [3, "count"], [1, "card"], ["icon", "\u2B21", "title", "Unable to load subscription", "message", "Please refresh the page to try again."], [1, "card", 2, "background", "linear-gradient(135deg,var(--brand),var(--brand-dark))", "color", "#fff", "border", "0", "margin-bottom", "26px"], [2, "display", "flex", "justify-content", "space-between", "align-items", "flex-start", "gap", "16px", "flex-wrap", "wrap"], [2, "font-size", "11px", "text-transform", "uppercase", "letter-spacing", "1px", "font-weight", "700", "color", "rgba(255,255,255,.7)"], [2, "display", "flex", "align-items", "center", "gap", "12px", "margin-top", "6px", "flex-wrap", "wrap"], [2, "margin", "0", "font-size", "28px", "font-weight", "800", "color", "#fff"], [1, "pill", 2, "background", "rgba(255,255,255,.2)", "color", "#fff"], [2, "font-size", "13px", "color", "rgba(255,255,255,.75)", "margin-top", "8px"], [2, "display", "flex", "gap", "10px", "flex-wrap", "wrap"], ["type", "button", 1, "btn", 2, "background", "transparent", "border", "1px solid rgba(255,255,255,.4)", "color", "#fff", 3, "click"], ["type", "button", 1, "btn", 2, "background", "#fff", "color", "var(--brand)", 3, "click"], [1, "grid", "grid-4", 2, "border-top", "1px solid rgba(255,255,255,.15)", "padding-top", "14px", "margin-top", "20px"], [2, "font-size", "11px", "text-transform", "uppercase", "letter-spacing", ".6px", "font-weight", "600", "color", "rgba(255,255,255,.65)"], [2, "font-weight", "700", "font-size", "15px", "margin", "4px 0 8px"], [1, "progress", 2, "background", "rgba(255,255,255,.25)"], [1, "bar", 2, "background", "#fff"], [1, "bar"], [2, "font-weight", "700", "font-size", "15px", "margin-top", "4px"], [2, "display", "flex", "align-items", "center", "gap", "14px", "flex-wrap", "wrap", "margin-bottom", "20px"], [2, "margin", "0", "font-size", "17px", "font-weight", "800"], [1, "tabs"], ["type", "button", 3, "click"], [1, "pill", "success"], ["id", "plans-grid", 1, "grid", "grid-4", 2, "margin-bottom", "26px"], [1, "card", 2, "position", "relative", "display", "flex", "flex-direction", "column"], [1, "card", "flush"], [1, "card-head"], [1, "card-title"], [1, "card-sub"], [1, "table-wrap"], ["icon", "\u2B21", "title", "No billing history yet", "message", "Charges will appear here once you subscribe to a plan."], [1, "ribbon", "current"], [1, "ribbon", "brand"], [2, "font-family", "var(--font-display)", "font-size", "18px", "font-weight", "700"], [2, "margin", "8px 0 4px"], [2, "font-family", "var(--font-display)", "font-size", "28px", "font-weight", "800", 3, "color"], [2, "font-size", "12px", "color", "var(--muted)", "margin-bottom", "12px"], [2, "display", "grid", "gap", "7px", "margin-bottom", "16px"], [2, "display", "flex", "gap", "8px", "align-items", "flex-start"], ["type", "button", "disabled", "", 1, "btn", "block", 2, "margin-top", "auto", "background", "var(--brand-pale)", "color", "var(--brand)", "opacity", "1"], ["type", "button", 1, "btn", "secondary", "block", 2, "margin-top", "auto"], ["type", "button", 1, "btn", "primary", "block", 2, "margin-top", "auto"], [2, "font-family", "var(--font-display)", "font-size", "28px", "font-weight", "800"], [2, "font-size", "13px", "color", "var(--muted)"], ["name", "check", 2, "margin-top", "1px", 3, "size"], [2, "font-size", "12px", "color", "var(--muted)", "line-height", "1.5"], ["type", "button", 1, "btn", "secondary", "block", 2, "margin-top", "auto", 3, "click"], ["type", "button", 1, "btn", "primary", "block", 2, "margin-top", "auto", 3, "click"], [1, "table", "stack-mobile"], ["data-label", "Date"], ["data-label", "Description", 1, "strong"], ["data-label", "Amount", 1, "num"], ["data-label", "Status"], [3, "status", "label"], ["data-label", ""], [1, "actions"], ["type", "button", 1, "btn", "ghost", "sm", 3, "click"], ["name", "download", 3, "size"], [2, "background", "var(--brand-pale)", "border-radius", "12px", "padding", "18px", "text-align", "center", "margin-bottom", "16px"], [2, "font-family", "var(--font-display)", "font-size", "30px", "font-weight", "800"], [2, "font-size", "12px", "color", "var(--green)", "font-weight", "600", "margin-top", "6px"], [2, "display", "grid", "gap", "7px"], ["type", "button", 1, "btn", "primary", 3, "click", "disabled"], ["name", "check", 2, "color", "var(--green)", "margin-top", "1px", 3, "size"]], template: function SubscriptionComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(9, "Are you sure? Your account will remain active until the end of the billing period. After that you'll lose access to paid features.");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275listener("click", function SubscriptionComponent_Template_button_click_13_listener() {
        return ctx.confirmCancel();
      });
      \u0275\u0275template(14, SubscriptionComponent_Conditional_14_Template, 1, 0, "span", 8);
      \u0275\u0275text(15, " Cancel Subscription ");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      let tmp_3_0;
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.saving() ? 14 : -1);
    }
  }, dependencies: [CommonModule, AppShellComponent, IconComponent, ModalComponent, PillComponent, EmptyStateComponent, SkeletonRowsComponent], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SubscriptionComponent, { className: "SubscriptionComponent", filePath: "src\\app\\features\\subscription\\subscription.component.ts", lineNumber: 233 });
})();
export {
  SubscriptionComponent
};
//# sourceMappingURL=chunk-ASUBGTME.js.map
