...
function SuperBrandingComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(12, SuperBrandingComponent_Conditional_10_Conditional_12_Template, 3, 1)(13, SuperBrandingComponent_Conditional_10_Conditional_13_Template, 4, 0);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(22, SuperBrandingComponent_Conditional_10_Conditional_22_Template, 3, 1)(23, SuperBrandingComponent_Conditional_10_Conditional_23_Template, 4, 0);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(83, "\u25E7 Invoices");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(84, "div", 31);
    \u0275\u0275text(85, "\u25C8 Payments");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(86, "div", 32)(87, "button", 33);
    \u0275\u0275text(88, "Primary Button");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(89, "button", 34);
    \u0275\u0275text(90, "Secondary Button");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var SuperBrandingComponent = class _SuperBrandingComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SuperBrandingComponent, selectors: [["app-super-branding"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 11, vars: 2, consts: [["logoInput", ""], ["favInput", ""], [1, "page-head"], [1, "page-actions"], ["type", "button", 1, "btn", "primary", 3, "click", "disabled"], [1, "card", "flush"], [1, "grid", "grid-wide"], [3, "count"], [2, "display", "grid", "gap", "16px", "align-content", "start"], [1, "card"], [1, "card-title", 2, "margin-bottom", "14px"], [1, "grid", "grid-2"], [2, "font-size", "12px", "font-weight", "600", "margin-bottom", "4px"], [2, "font-size", "11px", "color", "var(--muted)", "margin-bottom", "8px"], ["type", "button", 2, "width", "100%", "border", "2px dashed var(--border)", "border-radius", "10px", "padding", "22px", "text-align", "center", "background", "#fff", "cursor", "pointer", 3, "click"], ["type", "file", "accept", "image/*", "hidden", "", 3, "change"], [1, "grid", "grid-3"], [1, "field"], [2, "display", "flex", "gap", "8px", "align-items", "center"], ["type", "color", 2, "width", "42px", "height", "42px", "border", "1px solid var(--border)", "border-radius", "8px", "padding", "2px", "background", "#fff", "cursor", "pointer", "flex-shrink", "0", 3, "ngModelChange", "ngModel"], [1, "mono", 3, "ngModelChange", "ngModel"], [1, "grid", "grid-2", 2, "gap", "12px"], [3, "ngModelChange", "ngModel"], [1, "card", 2, "align-self", "start"], [2, "background", "linear-gradient(180deg,#1e1b4b,#312e81)", "border-radius", "12px", "padding", "14px"], [2, "display", "flex", "align-items", "center", "gap", "9px", "margin-bottom", "14px"], ["alt", "Logo", 2, "height", "28px", 3, "src"], [2, "width", "30px", "height", "30px", "border-radius", "8px", "display", "grid", "place-items", "center", "color", "#fff", "font-weight", "800", "font-size", "13px", 3, "background"], [2, "color", "#fff", "font-weight", "800", "font-size", "13px"], [2, "color", "rgba(165,180,252,.7)", "font-size", "10px"], [2, "border-radius", "8px", "padding", "8px 10px", "color", "#c7d2fe", "font-size", "12px", "font-weight", "600", "margin-bottom", "4px"], [2, "padding", "8px 10px", "color", "rgba(165,180,252,.7)", "font-size", "12px"], [2, "display", "grid", "gap", "10px", "margin-top", "16px"], ["type", "button", 2, "border", "0", "border-radius", "8px", "padding", "10px", "color", "#fff", "font-weight", "700", "font-size", "13px", "cursor", "default"], ["type", "button", 2, "background", "#fff", "border", "1.5px solid", "border-radius", "8px", "padding", "10px", "font-weight", "700", "font-size", "13px", "cursor", "default"], ["alt", "Logo", 2, "max-height", "40px", "max-width", "100%", "display", "block", "margin", "0 auto 8px", 3, "src"], [2, "font-size", "11px", "color", "var(--green)", "font-weight", "600"], [2, "font-size", "22px"], [2, "font-size", "12px", "color", "var(--muted)", "margin-top", "6px"], ["alt", "Favicon", 2, "max-height", "40px", "display", "block", "margin", "0 auto 8px", 3, "src"], [2, "width", "30px", "height", "30px", "border-radius", "8px", "display", "grid", "place-items", "center", "color", "#fff", "font-weight", "800", "font-size", "13px"]], template: function SuperBrandingComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(9, SuperBrandingComponent_Conditional_9_Template, 2, 1, "div", 5)(10, SuperBrandingComponent_Conditional_10_Template, 91, 23, "div", 6);
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
  ...
  }, dependencies: [CommonModule, FormsModule, DefaultValueAccessor, NgControlStatus, NgModel, SkeletonRowsComponent], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperBrandingComponent, { className: "SuperBrandingComponent", filePath: "src\\app\\features\\super-admin\\branding.component.ts", lineNumber: 137 });
})();
export {
  SuperBrandingComponent
};
//# sourceMappingURL=chunk-7EKGLPTX.js.map
