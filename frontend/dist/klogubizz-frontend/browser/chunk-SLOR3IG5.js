...
function SuperMastersComponent_Conditional_19_Case_2_For_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(4, "app-icon", 36);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const m_r13 = ctx.$implicit;
    \u0275\u0275styleProp("border", m_r13.active ? "2px solid var(--brand)" : "2px solid var(--border)")("background", m_r13.active ? "var(--brand-pale)" : "var(--card)");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(m_r13.label);
    \u0275\u0275advance();
    \u0275\u0275styleProp("color", m_r13.active ? "var(--green)" : "var(--faint)");
    \u0275\u0275advance();
    \u0275\u0275property("name", m_r13.active ? "check" : "x")("size", 12);
    \u0275\u0275advance();
...
function SuperMastersComponent_Conditional_19_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(10, SuperMastersComponent_Conditional_19_Case_2_For_11_Template, 6, 10, "button", 32, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function SuperMastersComponent_Conditional_19_Case_3_For_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275styleProp("border", u_r16.active ? "2px solid var(--brand)" : "2px solid var(--border)")("background", u_r16.active ? "var(--brand-pale)" : "var(--card)");
    \u0275\u0275advance();
...
function SuperMastersComponent_Conditional_19_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 31);
    \u0275\u0275repeaterCreate(10, SuperMastersComponent_Conditional_19_Case_3_For_11_Template, 5, 8, "button", 37, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function SuperMastersComponent_Conditional_19_Case_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(10, SuperMastersComponent_Conditional_19_Case_4_For_11_Template, 5, 2, "div", 43, _forTrack1);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
var SuperMastersComponent = class _SuperMastersComponent {
  ...
  }, dependencies: [CommonModule, FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, CheckboxControlValueAccessor, SelectControlValueAccessor, NgControlStatus, NgModel, SkeletonRowsComponent, IconComponent], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuperMastersComponent, { className: "SuperMastersComponent", filePath: "src\\app\\features\\super-admin\\masters.component.ts", lineNumber: 154 });
})();
export {
  SuperMastersComponent
};
//# sourceMappingURL=chunk-SLOR3IG5.js.map
