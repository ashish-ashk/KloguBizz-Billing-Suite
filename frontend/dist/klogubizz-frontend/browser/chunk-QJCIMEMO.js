...
function ClientsComponent_Conditional_12_For_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "app-avatar", 32);
    \u0275\u0275elementStart(4, "div")(5, "div", 33);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(9, "td");
    \u0275\u0275template(10, ClientsComponent_Conditional_12_For_15_Conditional_10_Template, 2, 1, "span", 35)(11, ClientsComponent_Conditional_12_For_15_Conditional_11_Template, 2, 0, "span", 36);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ClientsComponent_Conditional_12_For_15_Template_button_click_22_listener() {
      const c_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.deleteTarget.set(c_r2));
    });
    \u0275\u0275text(23, "Delete");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275property("name", c_r2.companyName)("size", 32);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(c_r2.companyName);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(c_r2.email || "\u2014");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(c_r2.gstin ? 10 : 11);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(c_r2.phone || "\u2014");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", ctx_r2.stateName(c_r2.stateCode), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("(", c_r2.stateCode, ")");
  }
}
function ClientsComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10)(1, "table", 30)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5, "Client");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    \u0275\u0275text(7, "GSTIN");
...
function ClientsComponent_For_44_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", s_r4.code);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", s_r4.name, " (", s_r4.code, ")");
  }
}
var ClientsComponent = class _ClientsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ClientsComponent, selectors: [["app-clients"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 63, vars: 27, consts: [["title", "Clients", 3, "subtitle"], ["actions", "", "type", "button", 1, "btn", "primary", 3, "click"], [1, "toolbar"], [1, "search-box"], [1, "search-icon"], ["type", "text", "placeholder", "Search name, GSTIN or email", 1, "input", 3, "ngModelChange", "ngModel"], [1, "card", "flush"], [3, "count"], ["icon", "\u25EB", "title", "No clients yet", "message", "Add your first client to start invoicing."], ["icon", "\u2315", "title", "No matching clients", "message", "Try a different search term."], [1, "table-wrap"], [3, "close", "open", "title"], [1, "form", 3, "ngSubmit"], [1, "field"], ["name", "companyName", "placeholder", "Acme Traders Pvt Ltd", 3, "ngModelChange", "ngModel"], [1, "error"], [1, "grid", "grid-2"], ["name", "email", "placeholder", "billing@acme.in", 3, "ngModelChange", "ngModel"], ["name", "phone", "placeholder", "98765 43210", 3, "ngModelChange", "ngModel"], ["name", "gstin", "placeholder", "27ABCDE1234F1Z5", 1, "mono", 3, "ngModelChange", "ngModel"], ["name", "address", "placeholder", "Street, city, PIN", 3, "ngModelChange", "ngModel"], ["name", "stateCode", 3, "ngModelChange", "ngModel"], [3, "value"], [1, "modal-foot"], ["type", "button", 1, "btn", "ghost", 3, "click"], ["type", "submit", 1, "btn", "primary", 3, "disabled"], ["title", "Delete Client", 3, "close", "open", "width"], [2, "margin", "0 0 8px", "font-size", "13.5px"], [2, "margin", "0", "font-size", "12.5px", "color", "var(--muted)"], ["type", "button", 1, "btn", "danger", "solid", 3, "click", "disabled"], [1, "table"], [2, "display", "flex", "align-items", "center", "gap", "10px"], [3, "name", "size"], [1, "strong"], [1, "muted", 2, "font-size", "11.5px"], [1, "mono"], [1, "muted"], [1, "actions"], ["type", "button", 1, "btn", "ghost", "sm", 3, "click"], ["type", "button", 1, "btn", "danger", "sm", 3, "click"]], template: function ClientsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(9, ClientsComponent_Conditional_9_Template, 1, 1, "app-skeleton-rows", 7)(10, ClientsComponent_Conditional_10_Template, 1, 0, "app-empty-state", 8)(11, ClientsComponent_Conditional_11_Template, 1, 0, "app-empty-state", 9)(12, ClientsComponent_Conditional_12_Template, 16, 0, "div", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "app-modal", 11);
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(19, ClientsComponent_Conditional_19_Template, 2, 0, "span", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(20, "div", 16)(21, "div", 13)(22, "label");
      \u0275\u0275text(23, "Email");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(25, ClientsComponent_Conditional_25_Template, 2, 0, "span", 15);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(34, ClientsComponent_Conditional_34_Template, 2, 0, "span", 15);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275repeaterCreate(43, ClientsComponent_For_44_Template, 2, 3, "option", 22, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(45, "div", 23)(46, "button", 24);
      ...
      \u0275\u0275text(49);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(50, "app-modal", 26);
  ...
  }, dependencies: [CommonModule, FormsModule, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, NgForm, AppShellComponent, ModalComponent, AvatarComponent, EmptyStateComponent, SkeletonRowsComponent], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ClientsComponent, { className: "ClientsComponent", filePath: "src\\app\\features\\clients\\clients.component.ts", lineNumber: 153 });
})();
export {
  ClientsComponent
};
//# sourceMappingURL=chunk-QJCIMEMO.js.map
